...
I enjoy working with data, building systems and solving real-world problems through scalable solutions. My goal is to become a **full-time Data Engineer**, focusing on designing data pipelines, transforming data and enabling data-driven decision-making.
...
- Currently shifting into **Data Engineering**
...
![REST API](https://img.shields.io/badge/API-FF6C37?style=for-the-badge&logo=fastapi&logoColor=white)
...
![ETL](https://img.shields.io/badge/ETL_Pipelines-6DB33F?style=for-the-badge&logo=apacheairflow&logoColor=white)
...
- 🔹 Data pipeline projects (ETL workflows)
- 🔹 SQL-based analytics projects
- 🔹 Power BI dashboards
- 🔹 Backend systems integrating data workflows
...
- Master modern data stack tools
